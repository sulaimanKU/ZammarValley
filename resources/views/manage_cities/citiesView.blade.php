...
<div class="main-page-wrapper">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold text-dark mb-0">Manage City</h3>
                <p class="text-muted small mb-0">Manage and define specific City</p>
            </div>
        ...
        <div class="collapse" id="addBox">
            <div class="quick-add-box p-4">
                <form action="{{route('city.store')}}" class="row g-3 align-items-end" method="POST">
                    @csrf
                    <div class="col-md-9">
                        <label class="form-label fw-bold small text-secondary">City NAME</label>
                        <input type="text" name="name" class="form-control form-control-lg" placeholder="Enter City name...">
                    </div>
                    <div class="col-md-3">
                        <button type="submit" class="btn btn-dark btn-lg w-100">Save City</button>
                    </div>
                </form>
            </div>
        </div>
